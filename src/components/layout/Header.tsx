        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            {isPOSPage ? (
              <>
                <Link to="/">
                  <Button variant="ghost">Back to XANTECHS</Button>
                </Link>
                <a
                ...
                >
                  <Button className="gradient-primary">Get on Google Play</Button>
                </a>
              </>
            ) : (
              <>
              ...
              {isPOSPage ? (
                <>
                  <Link to="/" onClick={() => setIsOpen(false)}>
                    <Button variant="ghost" className="w-full">Back to XANTECHS</Button>
                  </Link>
                  <a
                    href="https://play.google.com/store"
                    target="_blank"
